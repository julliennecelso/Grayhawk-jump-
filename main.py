...
class Background(Widget):
    ...
    def scroll_textures(self, time_passed):
        ...
        self.cloud_texture.uvpos = ( (self.cloud_texture.uvpos[0] + time_passed/6.0)%Window.width, self.cloud_texture.uvpos[1])
...
class MainApp(App):
    ...
    def start_game(self):
        ...
        # Create the pipes
        num_pipes = 5
        distance_between_pipes = Window.width / (num_pipes - .5)
